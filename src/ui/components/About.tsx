...
export const About = () => {
  ...
  return (
    <div className="bg-sky-dark/90 font-russo pointer-events-auto absolute inset-0 z-50 flex flex-col items-center justify-center text-white backdrop-blur-lg">
      <h1 className="mb-5 text-7xl italic drop-shadow-lg">SYSTEM INFO</h1>

      <div className="border-sky mb-10 max-w-2xl -skew-x-3 transform rounded-md border-2 bg-black/50 p-10 text-center shadow-[0_0_20px_rgba(135,206,235,0.2)]">
